                          ...
                          Expanded(
                            child: Text(
                              p.rentalEndDate != null
                                  ? 'This item is currently being rented by another user and will be available again after '
                                  '${p.rentalEndDate!.day}/${p.rentalEndDate!.month}/${p.rentalEndDate!.year}.'
        ...
        child: Padding(
          ...
          child: Row(children: [
            ...
            Expanded(
              flex: 2,
              child: ElevatedButton(
                onPressed: _isLoading || widget.product.status != 'available' ? null : _addToCart,
                style: ElevatedButton.styleFrom(
                  backgroundColor: primaryColor,
                  foregroundColor: Colors.white,
                  padding: const EdgeInsets.symmetric(vertical: 14),
