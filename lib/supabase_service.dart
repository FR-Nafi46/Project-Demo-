...
class SupabaseService {
  ...
  // Check if current user can perform actions (sell/buy/rent)
  ...
  static Future<void> uploadNIDImages(String userId, File frontImage, File backImage) async {
    ...
    // Update profile with NID images and request verification
    await upsertProfile({
      'id': userId,
  ...
  static Future<List<Map<String, dynamic>>> fetchProducts(
    ...
    var query = client.from('products').select(
        '*, profiles(full_name, avatar_url, nid_verified, is_banned)');
