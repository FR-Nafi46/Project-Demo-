...
class SupabaseService {
  ...
  static Future<List<Map<String, dynamic>>> fetchMessages(
    ...
    final data = await client
        .from('messages')
        .select('id, conversation_id, sender_id, text, image_url, read_at, created_at, sender:profiles!messages_sender_id_fkey(full_name)')
  ...
  // Upload an image for chat and return its public URL
  static Future<String> uploadChatImage(
      String userId, String conversationId, Uint8List bytes) async {
    final ts = DateTime.now().microsecondsSinceEpoch;
    final fileName = '$userId/${conversationId}_$ts.jpg';
