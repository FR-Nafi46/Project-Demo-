...
class _UserProfilePageState extends State<UserProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final walletBalance = (_profile?['wallet_balance'] as num?)?.toDouble() ?? 0.0;
...
// ─────────────────────────────────────────────────────────────
// NID image card with tap-to-fullscreen
// ─────────────────────────────────────────────────────────────
class _NidImageCard extends StatelessWidget {
  final String label;
  final String url;
  const _NidImageCard({required this.label, required this.url});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => _FullScreenImagePage(url: url, title: '$label NID')),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
              ...
              children: [
                Image.network(
                  ...
                  loadingBuilder: (_, child, progress) {
                    ...
                    return Container(height: 110, color: Colors.grey.shade200, alignment: Alignment.center,
                        child: const CircularProgressIndicator(strokeWidth: 2));
                  },
                  errorBuilder: (_, __, ___) => Container(
                    height: 110, color: Colors.grey.shade200,
...
// ─────────────────────────────────────────────────────────────
// Full-screen image viewer (reused for NID)
// ─────────────────────────────────────────────────────────────
